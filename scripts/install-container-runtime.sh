...
install-podman() {
    ...
    local -r repo_url="https://download.opensuse.org/repositories/devel:/kubic:/libcontainers:/stable/xUbuntu_${VERSION_ID}/"

    add_apt_repo devel:kubic:libcontainers:stable "${repo_url}Release.key" "deb ${repo_url} /"
